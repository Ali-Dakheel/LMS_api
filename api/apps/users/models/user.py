...
PASSWORD_HISTORY_CHECK_COUNT = 5  # Number of recent passwords to check for reuse
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def change_password(self, old_password, new_password):
        ...
        recent_passwords = self.password_history.only('hashed_password')[:PASSWORD_HISTORY_CHECK_COUNT]
